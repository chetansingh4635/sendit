...
var route = new Route('post', '/secure/removeOthersIntrest');
 ...
 */
route.use(function(req, res, next){
    if(res.locals.request.partner && res.locals.request.partner.length > 0 && res.locals.request.partner[0].userId._id === req.user._id){
