...
sinonStubPromise(sinon);
 ...
 describe('/admin/payments', function () {
    ...
    var allPayments = proxyquire('../../routes/admin/canceledPartnerships.js',{
        ...
        it('should login, admin',function(){
            ...
            db.FirstMiddleware = sinon.stub().callsArgWith(2, null, req, res);
        ...
        it('should login, admin',function(){
            ...
            var spy = sinon.spy();
            var FirstMiddleware = allPayments.middlewares[1];
